...
namespace FisherManNPC.NPCs
{
	...
	public class fisherman : ModNPC
	{
		public override string Texture
		{
			get
			{
				return "FisherManNPC/NPCs/fisherman";
			}
		}
		...
		public override string TownNPCName()
		{
			...
			{
				case 0:
					return "Fisherman - Totally not a example mod npc";
				case 1:
					return "Fisherman";
				case 2:
					return "FushirMIn";
				default:
					return "FisherMan - Ама фищир мен";
			}
		}
		...
		public override string GetChat()
		{
			...
			{
				return "Can you please tell " + Main.npc[partyGirl].GivenName + " to stop decorating my house with giggigigigigigigi?";
			}
			switch (Main.rand.Next(3))
			{
				...
				case 1:
					return "lol kek cheburek. What is does?";
				default:
